...
async def get_max_supply():
    async with aiohttp.ClientSession() as session:
        async with session.get(
            "https://api.spectre-network.org/info/coinsupply/max",
...
async def get_circulating_supply():
    async with aiohttp.ClientSession() as session:
        async with session.get(
            "https://api.spectre-network.org/info/coinsupply/circulating?in_billion=false",
            headers={"accept": "text/plain"},
        ) as response:
...
async def get_hashrate():
    async with aiohttp.ClientSession() as session:
        async with session.get(
            "https://api.spectre-network.org/info/hashrate?stringOnly=false",
...
async def get_blockreward():
    async with aiohttp.ClientSession() as session:
        async with session.get(
            "https://api.spectre-network.org/info/blockreward?stringOnly=false",
            headers={"accept": "application/json"},
        ) as response:
...
async def get_price_data():
    async with aiohttp.ClientSession() as session:
        async with session.get(
            "https://api.spectre-network.org/info/price?stringOnly=false",
            headers={"accept": "application/json"},
        ) as response:
...
async def get_market_cap():
    async with aiohttp.ClientSession() as session:
        async with session.get(
            "https://api.spectre-network.org/info/marketcap?stringOnly=false",
            headers={"accept": "application/json"},
        ) as response:
...
async def calc(ctx, hashrate: float = None):
    ...
    if (
        ...
        await ctx.send(
            "Failed to retrieve network information or SPR price. Please try again later."
        )
